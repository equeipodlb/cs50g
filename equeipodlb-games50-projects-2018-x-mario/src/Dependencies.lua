...
gTextures = {
    ...
    ['goalposts'] = love.graphics.newImage('graphics/flags.png'),
...
gFrames = {
    ...
    ['keys'] = GenerateQuadsKeys(gTextures['keys']),
    ['locks'] = GenerateQuadsLocks(gTextures['locks']),
    ['goalposts'] = GenerateQuadsGoalPosts(gTextures['goalposts']),
