    ...
    if self.level == 1 then
        for tileY = 1, 8 do
            ...
            for tileX = 1, 8 do
                ...
                -- create a new tile at X,Y with a random color and the one variety
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), 1, math.random(10)))
            end
        end
        ...
        for tileY = 1, 8 do
            ...
            for tileX = 1, 8 do
                ...
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(6),math.random(10)))
            end
        end
    end
                ...
                if matchNum >= 3 then
                    ...
                    for x2 = x - 1, x - matchNum, -1 do
                        if (self.tiles[y][x2].shiny == true) then
                            for x3 = 1, 8 do -- If we found a shiny one we add the whole row
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                local tile
                if self.level == 1 then 
                    tile = Tile(x, y, math.random(18), 1,math.random(10))
                else
                    tile = Tile(x,y,math.random(18), math.random(6), math.random(10))
                end
                tile.y = -32
                self.tiles[y][x] = tile
...
function Board:isThereAnyMatches()
    for y=1,8 do
		for x=1,8 do
